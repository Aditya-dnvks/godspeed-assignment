...
export namespace Prisma {
  ...
  */
  ...
  export type RestaurantSelect = {
    ...
    description?: boolean
    location?: boolean
    menuItems?: boolean | MenuItemsFindManyArgs
  ...
  export class Prisma__RestaurantClient<T> implements PrismaPromise<T> {
    ...
    menuItems<T extends MenuItemsFindManyArgs = {}>(args?: Subset<T, MenuItemsFindManyArgs>): CheckSelect<T, PrismaPromise<Array<MenuItems>>, PrismaPromise<Array<MenuItemsGetPayload<T>>>>;
  ...
  export type MenuItemsGroupByArgs = {
    ...
    by: Array<MenuItemsScalarFieldEnum>
  ...
  type GetMenuItemsGroupByPayload<T extends MenuItemsGroupByArgs> = PrismaPromise<
    Array<
  ...
  export type MenuItemsGetPayload<
    S extends boolean | null | undefined | MenuItemsArgs,
    U = keyof S
      > = S extends true
        ? MenuItems
    : S extends undefined
    ? never
    : S extends MenuItemsArgs | MenuItemsFindManyArgs
    ?'include' extends U
    ? MenuItems  & {
    [P in TrueKeys<S['include']>]:
  ...
  export interface MenuItemsDelegate<GlobalRejectSettings> {
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'MenuItems'> extends True ? CheckSelect<T, Prisma__MenuItemsClient<MenuItems>, Prisma__MenuItemsClient<MenuItemsGetPayload<T>>> : CheckSelect<T, Prisma__MenuItemsClient<MenuItems | null >, Prisma__MenuItemsClient<MenuItemsGetPayload<T> | null >>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'MenuItems'> extends True ? CheckSelect<T, Prisma__MenuItemsClient<MenuItems>, Prisma__MenuItemsClient<MenuItemsGetPayload<T>>> : CheckSelect<T, Prisma__MenuItemsClient<MenuItems | null >, Prisma__MenuItemsClient<MenuItemsGetPayload<T> | null >>
    ...
    **/
    ...
    ): CheckSelect<T, PrismaPromise<Array<MenuItems>>, PrismaPromise<Array<MenuItemsGetPayload<T>>>>
    ...
    **/
    ...
    ): CheckSelect<T, Prisma__MenuItemsClient<MenuItems>, Prisma__MenuItemsClient<MenuItemsGetPayload<T>>>
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends MenuItemsAggregateArgs>(args: Subset<T, MenuItemsAggregateArgs>): PrismaPromise<GetMenuItemsAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, MenuItemsGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetMenuItemsGroupByPayload<T> : PrismaPromise<InputErrors>
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__MenuItemsClient<T> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
   ...
   */
  export type MenuItemsFindUniqueArgs = {
    /**
    ...
    **/
    ...
    /**
     * Throw an Error if a MenuItems can't be found
     * 
    **/
    rejectOnNotFound?: RejectOnNotFound
    /**
   ...
   * MenuItems findFirst
   */
  export type MenuItemsFindFirstArgs = {
    /**
     * Select specific fields to fetch from the MenuItems
     * 
    **/
